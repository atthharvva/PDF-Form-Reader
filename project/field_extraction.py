...
def find_field_values(text_by_page, FIELDS, field_mappings):
    ...
    post_process_dates_and_reasons(FIELDS, text_by_page)

def post_process_dates_and_reasons(FIELDS, text_by_page):
    if len(text_by_page) != 4:
        if FIELDS["Date you lost your card"] != None and len(FIELDS["Date you lost your card"].split()) > 1:
        ...
        if FIELDS["Time you lost your card"] != None and len(FIELDS["Time you lost your card"].split()) > 1:
        ...
        if FIELDS["Date you realised card was stolen"] != None and len(FIELDS["Date you realised card was stolen"].split()) > 1:
        ...
        if FIELDS["Time you realised card was stolen"] != None and len(FIELDS["Time you realised card was stolen"].split()) > 1:
